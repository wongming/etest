...
import loader, runner, notice
UsageInfo = """\
Usage: etest [options] [argv] [...]
...
Examples:
        ...
        stest -p ts_xxx           - run plan from plans of a dir
        stest -p xxx.plan.json    - run a plan from a file
"""
VersionInfo = 'etest version "1.0"'
class TestProgram(object):
    ...
    def parseArgs(self, argv):
        ...
        short_opts= "hHvc:p:d"
        try:
            options, args = getopt.getopt(argv[1:], short_opts, long_opts)
